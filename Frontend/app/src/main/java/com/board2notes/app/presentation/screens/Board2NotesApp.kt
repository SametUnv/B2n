...
private val mainDrawerDestinations = listOf(
    ...
    NavigationDestination(Route.Notes, "TÃ¼m Notlar", Icons.Default.Description),
    NavigationDestination(Route.Archive, "ArÅŸivlenenler", Icons.Default.Archive),
    NavigationDestination(Route.Trash, "Ã‡Ã¶p Kutusu", Icons.Default.Delete)
)
...
fun Board2NotesApp(viewModel: Board2NotesViewModel) {
    ...
    val cameraPermissionLauncher = rememberLauncherForActivityResult(ActivityResultContracts.RequestPermission()) { granted ->
        if (granted) {
            ...
            viewModel.showMessage("Kamera izni olmadan fotoÄŸraf Ã§ekilemez.")
        }
    }
    ...
    Scaffold(
                    ...
                    CenterAlignedTopAppBar(
                        ...
                        actions = {
                            IconButton(onClick = {
                                ...
                                Icon(Icons.Default.Folder, contentDescription = "ArÅŸivle", tint = Color.White)
                            }
                            IconButton(onClick = {
                ...
                Surface(
                    ...
                    Box(
                        ...
                        Icon(
                            ...
                            contentDescription = "Yeni Not OluÅŸtur",
        ...
        Box(
            ...
            if (state.isBusy) {
                ...
                BoardLoadingOverlay(message = "Not alanÄ± hazÄ±rlanÄ±yor.")
            }
        }
    }
}
...
private fun TopLevelOverflowMenu(
    ...
    DropdownMenu(
        ...
        DropdownMenuItem(
            text = { Text("ArÅŸivlenenler", fontWeight = FontWeight.Medium, color = itemColor) },
        ...
        if (showHomeOptions) {
            ...
            DropdownMenuItem(
                text = { Text("Ã‡oklu SeÃ§", fontWeight = FontWeight.Medium, color = itemColor) },
            ...
            DropdownMenuItem(
                text = { Text("SÄ±rala", fontWeight = FontWeight.Medium, color = itemColor) },
            ...
            DropdownMenuItem(
                text = { Text("Ders OluÅŸtur", fontWeight = FontWeight.Medium, color = itemColor) },
    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                NoteTypeChoiceRow(
                    title = "YazÄ± Notu",
                    subtitle = "OCR metni ve elle yazÄ±lan ders notlarÄ±",
                    icon = Icons.Default.TextFields,
                    onClick = onCreateText
                )
                NoteTypeChoiceRow(
                    title = "Canvas Notu",
                    subtitle = "Tahta Ã§Ä±ktÄ±larÄ±, Ã§izim ve serbest sayfa",
...
private fun loadingMessage(state: Board2NotesUiState): String = when {
    state.pendingScanNoteId != null -> "FastAPI Model 1 ve Model 2 Ã§alÄ±ÅŸÄ±yor; Ã§Ä±ktÄ± aÃ§Ä±k nota yerleÅŸtirilecek."
    state.screen == com.board2notes.app.presentation.state.AppScreen.ImageReview -> "GÃ¶rsel hazÄ±rlanÄ±yor."
    state.screen == com.board2notes.app.presentation.state.AppScreen.BoardDetection -> "Tahta alanÄ± bulunuyor."
    state.screen == com.board2notes.app.presentation.state.AppScreen.Enhancement -> "Model 2 gÃ¶rÃ¼ntÃ¼yÃ¼ iyileÅŸtiriyor."
    state.screen == com.board2notes.app.presentation.state.AppScreen.Ocr -> "OCR metni Ã§Ä±karÄ±lÄ±yor."
...
private fun HomeScreen(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ScreenColumn {
            ...
            Text(
                text = if (searchQuery.isNotBlank()) "Arama SonuÃ§larÄ± (${sortedNotes.size})" else "TÃ¼m Notlar",
                style = MaterialTheme.typography.titleMedium,
                fontWeight = FontWeight.Bold,
                color = MaterialTheme.colorScheme.onBackground.copy(alpha = 0.8f)
            )
                            ...
                            Box(
                                ...
                                Box(
                                    ...
                                    DropdownMenu(
                                        ...
                                        DropdownMenuItem(
                                            text = { Text("AÃ§", fontWeight = FontWeight.Medium, color = itemColor) },
                                        ...
                                        DropdownMenuItem(
                                            text = { Text(if (isFav) "Favorilerden Ã‡Ä±kar" else "Favoriye Ekle", fontWeight = FontWeight.Medium, color = itemColor) },
                                            leadingIcon = {
                                                Icon(
                                        ...
                                        DropdownMenuItem(
                                            text = { Text("ArÅŸivle", fontWeight = FontWeight.Medium, color = itemColor) },
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            Column(modifier = Modifier.padding(12.dp)) {
                ...
                Surface(
                    ...
                    Text(
                        text = if (note.noteType == NoteType.Canvas) "Canvas" else "YazÄ±",
                        style = MaterialTheme.typography.labelSmall,
                        fontWeight = FontWeight.Bold,
                        color = MaterialTheme.colorScheme.primary,
                        modifier = Modifier.padding(horizontal = 7.dp, vertical = 2.dp)
                ...
                Text(
                    text = note.title.ifBlank { "BaÅŸlÄ±ksÄ±z Not" },
                    style = MaterialTheme.typography.titleSmall,
                    fontWeight = FontWeight.Bold,
                    color = MaterialTheme.colorScheme.onSurface,
                    maxLines = 1,
                ...
                Text(
                    text = note.body.ifBlank { "Not iÃ§eriÄŸi boÅŸ." },
...
private fun HomeEmptyNotesCard() {
    Surface(
        ...
        Column(
            ...
            Text(
                "Ä°lk tahta notunuzu oluÅŸturarak baÅŸlayÄ±n.",
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
        }
...
private fun ConfirmDeleteNoteDialog(
    onDismiss: () -> Unit,
    onConfirm: () -> Unit,
    title: String = "Notu silmek istediÄŸinize emin misiniz?",
    ...
    AlertDialog(
        ...
        text = { Text("Bu iÅŸlem geri alÄ±namaz.") },
        confirmButton = {
            Button(
                onClick = onConfirm,
        ...
        dismissButton = {
            TextButton(onClick = onDismiss) {
                Text("VazgeÃ§", color = MaterialTheme.colorScheme.secondary)
            }
        }
    )
}
...
private fun SamsungCaptureScreen(onPick: () -> Unit, onCamera: () -> Unit) {
    Column(
        ...
        Spacer(Modifier.height(6.dp))
        Text(
            "Beyaz tahta veya slayt ekranÄ±nÄ± Ã§ekerek otomatik ders notuna dÃ¶nÃ¼ÅŸtÃ¼rÃ¼n.",
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
            lineHeight = 22.sp
        )
        ...
        Surface(
            ...
            Column(modifier = Modifier.padding(18.dp)) {
                ...
                Spacer(Modifier.height(12.dp))
                WorkflowStepRow("1", "FotoÄŸraf Ã‡ek / YÃ¼kle", "SÄ±nÄ±f tahtasÄ± veya projeksiyon ekranÄ±nÄ± net bir aÃ§Ä±dan Ã§ekin.")
                Spacer(Modifier.height(10.dp))
                WorkflowStepRow("2", "Perspektif KÃ¶ÅŸeleri Belirle", "Otomatik tespit edilen kÃ¶ÅŸeleri elle hassas ÅŸekilde dÃ¼zenleyin.")
                Spacer(Modifier.height(10.dp))
                WorkflowStepRow("3", "AI Ä°yileÅŸtirme ve OCR", "GÃ¶rÃ¼ntÃ¼ arka planÄ± temizlenir, metinler taranÄ±r ve notunuza aktarÄ±lÄ±r.")
            }
        }
        ...
        Row(
            ...
            OutlinedButton(
                ...
                Spacer(Modifier.width(8.dp))
                Text("Galeriden SeÃ§", style = MaterialTheme.typography.labelLarge, fontWeight = FontWeight.Bold)
            }
            ...
            Button(
                ...
                Spacer(Modifier.width(8.dp))
                Text("FotoÄŸraf Ã‡ek", style = MaterialTheme.typography.labelLarge, fontWeight = FontWeight.Bold)
            }
        }
    }
}
...
private fun SamsungImageReviewScreen(
    ...
    Column(
        ...
        Column(
            ...
            Spacer(Modifier.height(12.dp))
            Text(
                if (addingToNote) "TahtayÄ± nota ekle" else "GÃ¶rseli kontrol et",
                style = MaterialTheme.typography.titleLarge,
                fontWeight = FontWeight.SemiBold,
                color = MaterialTheme.colorScheme.onSurface
            )
            Spacer(Modifier.height(6.dp))
            Text(
                if (addingToNote) "Backend Ã§Ä±ktÄ±sÄ± bu aÃ§Ä±k nota eklenecek." else "Gerekirse dÃ¶ndÃ¼r, sonra devam et.",
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
            Spacer(Modifier.height(18.dp))
            Surface(
                ...
                Box(
                    ...
                    } ?: StatusBanner("GÃ¶rÃ¼ntÃ¼ yÃ¼kleniyor...", busy = true)
                }
            }
            Spacer(Modifier.height(14.dp))
        }
        Surface(
            ...
            Row(
                ...
                Button(
                    ...
                    Spacer(Modifier.width(8.dp))
                    Text(if (addingToNote) "TahtayÄ± ekle" else "Devam et")
                }
            }
        }
    }
...
private fun CaptureScreen(onPick: () -> Unit, onCamera: () -> Unit) {
    Column(
        ...
        Spacer(Modifier.height(8.dp))
        Text(
            "En iyi sonuÃ§lar iÃ§in tahta kÃ¶ÅŸelerinin kadraja sÄ±ÄŸdÄ±ÄŸÄ±ndan emin olun.",
            style = MaterialTheme.typography.bodyMedium,
            ...
            Surface(
                ...
                Box(contentAlignment = Alignment.Center) {
                    Icon(
                        ...
                        contentDescription = "Galeriden SeÃ§",
                        tint = Color.White,
                        modifier = Modifier.size(22.dp)
                    )
                }
            ...
            Surface(
                ...
                Box(contentAlignment = Alignment.Center) {
                    Icon(
                        ...
                        contentDescription = "FlaÅŸ Otomatik",
    ...
    Column(
        ...
        Column(
            ...
            SectionTitle(
                ...
                if (addingToNote) "Bu gÃ¶rÃ¼ntÃ¼ aÃ§Ä±k nota eklenecek." else "Gerekirse dÃ¶ndÃ¼r, sonra devam et."
            )
            Spacer(Modifier.height(16.dp))
            Surface(
                modifier = Modifier
...
private fun BoardCropScreen(
    ...
    Column(
        ...
        Spacer(Modifier.height(18.dp))
        if (state.isBusy) {
            StatusBanner("Tahta alanÄ± bulunuyor...", busy = true)
            Spacer(Modifier.height(12.dp))
        }
...
private fun BoardCropHeader() {
    Column(modifier = Modifier.fillMaxWidth()) {
        ...
        Spacer(Modifier.height(6.dp))
        Text(
            "TahtanÄ±n kÃ¶ÅŸelerini kontrol edin ve gerekli dÃ¼zenlemeleri yapÄ±n.",
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant
        )
    }
...
private fun isManualCropAppliedWarning(message: String): Boolean =
    message.equals("Elle dÃ¼zeltilmiÅŸ kÄ±rpma uygulandÄ±.", ignoreCase = true) ||
    ...
    Surface(
        ...
        Column(Modifier.padding(14.dp)) {
            ...
            OutlinedButton(
                ...
                Spacer(Modifier.width(8.dp))
                Text("Ä°ÅŸlemi atla â†’ Not EditÃ¶rÃ¼")
            }
        }
    }
}
...
private fun ManualCornerEditor(state: Board2NotesUiState, viewModel: Board2NotesViewModel) {
    ...
    val labels = listOf("Sol Ã¼st", "SaÄŸ Ã¼st", "SaÄŸ alt", "Sol alt")
    Surface(
        modifier = Modifier.fillMaxWidth(),
        shape = RoundedCornerShape(22.dp),
        color = MaterialTheme.colorScheme.surface,
        ...
        Column(Modifier.padding(16.dp)) {
            ...
            Spacer(Modifier.height(4.dp))
            Text(
                "KÃ¶ÅŸeleri ince ayarla ve crop sonucunu yenile.",
                style = MaterialTheme.typography.bodySmall,
                color = MaterialTheme.colorScheme.onSurfaceVariant
            )
            Spacer(Modifier.height(14.dp))
            ...
            OutlinedButton(
                ...
                Spacer(Modifier.width(8.dp))
                Text("TahtayÄ± dÃ¼zelt", fontWeight = FontWeight.SemiBold)
            }
        }
    }
}
...
private fun EnhancementResultScreen(state: Board2NotesUiState, viewModel: Board2NotesViewModel, onRunOcr: () -> Unit) {
    ...
    ScreenColumn {
        ...
        Spacer(Modifier.height(16.dp))
        SectionTitle("Ä°yileÅŸtirme sonucu", "Model 2 iki Ã§Ä±ktÄ± Ã¼retir: OCR gÃ¶rÃ¼ntÃ¼sÃ¼ ve beyaz sayfa.")
        Spacer(Modifier.height(12.dp))
        if (state.isBusy) StatusBanner("YazÄ± belirginleÅŸtiriliyor...", busy = true)
        ...
        enhancement?.let {
            ...
            TabRow(selectedTabIndex = tab) {
                Tab(selected = tab == 0, onClick = { tab = 0 }, text = { Text("OCR GÃ¶rÃ¼ntÃ¼sÃ¼") })
            ...
            if (state.settings.debugMode) {
                Spacer(Modifier.height(10.dp))
                Text("SÃ¼re: ${it.elapsedMs} ms", style = MaterialTheme.typography.bodySmall)
            }
            Spacer(Modifier.height(16.dp))
            Button(onClick = onRunOcr, modifier = Modifier.fillMaxWidth()) {
                Icon(Icons.Default.Check, contentDescription = null)
                Spacer(Modifier.width(8.dp))
                Text("OCR ile metne Ã§evir")
            }
        }
    }
}
...
private fun OcrReviewScreen(state: Board2NotesUiState, onOpenNote: () -> Unit) {
    ScreenColumn {
        ...
        Spacer(Modifier.height(16.dp))
        SectionTitle("OCR sonucu", "Metin Ã§Ä±karÄ±mÄ± tamamlanÄ±nca not editÃ¶rÃ¼ aÃ§Ä±labilir.")
        Spacer(Modifier.height(12.dp))
        if (state.isBusy) StatusBanner("ML Kit Latin OCR Ã§alÄ±ÅŸÄ±yor...", busy = true)
        ...
        state.ocrResult?.let { result ->
            Surface(
                ...
                Text(result.rawText.ifBlank { "OCR sonucu boÅŸ." }, modifier = Modifier.padding(12.dp))
            }
            Spacer(Modifier.height(14.dp))
...
private fun SamsungStyleNoteEditorScreen(
    ...
    // YazÄ± notu iÃ§eriÄŸi (Text tÃ¼rÃ¼)
    ...
    // Canvas durumu (Canvas tÃ¼rÃ¼) â€” denetleyici tÃ¼m Ã§izim durumunu tutar
            ...
            Row(
                ...
                Box {
                    ...
                    DropdownMenu(
                        ...
                        DropdownMenuItem(
                            text = { Text("GÃ¶rsel ekle", fontWeight = FontWeight.Medium, color = itemColor) },
                ...
                Box {
                    ...
                    DropdownMenu(
                        ...
                        DropdownMenuItem(
                            text = { Text("Ders seÃ§", fontWeight = FontWeight.Medium, color = itemColor) },
                            leadingIcon = { Icon(Icons.Default.Folder, contentDescription = null, modifier = Modifier.size(20.dp), tint = MaterialTheme.colorScheme.primary) },
                            onClick = {
                                showMoreMenu = false
                        ...
                        DropdownMenuItem(
                            text = { Text("Kaydet ve notlara dÃ¶n", fontWeight = FontWeight.Medium, color = itemColor) },
                        ...
                        DropdownMenuItem(
                            text = { Text("PaylaÅŸ", fontWeight = FontWeight.Medium, color = itemColor) },
        ...
        if (query.isNotBlank()) {
            Column(modifier = Modifier.padding(horizontal = 16.dp)) {
                if (searchResults.isEmpty()) {
                    EmptyState("SonuÃ§ bulunamadÄ±", "\"$query\" iÃ§in eÅŸleÅŸen not yok.")
                } else {
                    Row(
                        modifier = Modifier.fillMaxWidth(),
                        horizontalArrangement = Arrangement.SpaceBetween,
            ...
            if (state.savedNotes.isEmpty()) {
                Column(modifier = Modifier.padding(horizontal = 16.dp)) {
                    EmptyState("HenÃ¼z not yok", "Ä°lk tahta fotoÄŸrafÄ±nÄ± iÅŸleyerek not oluÅŸtur.")
                }
            } else {
...
private fun NotesHeroHeader(
    ...
    Surface(
        ...
        Box(
            ...
            Column {
                Text(
                    "Derslere gÃ¶re dÃ¼zenle, hÄ±zlÄ± ara.",
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
                Spacer(Modifier.height(12.dp))
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    if (latestEpochMs != null) {
                        Spacer(Modifier.width(10.dp))
                        Text(
                            "Son gÃ¼ncelleme: ${formatDate(latestEpochMs)}",
                            style = MaterialTheme.typography.labelMedium,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
...
private fun NoteDetailScreen(
    ...
    if (showDeleteDialog) {
        AlertDialog(
            ...
            title = {
                Text(
                    "Notu silmek istediÄŸinize emin misiniz?",
                    fontWeight = FontWeight.Bold
                )
            },
            text = { Text("Bu iÅŸlem geri alÄ±namaz.") },
    ...
    ScreenColumn {
        Spacer(Modifier.height(16.dp))
        if (note == null) {
            StatusBanner("Not yÃ¼kleniyor...", busy = true)
            return@ScreenColumn
        }
        ...
        Surface(
            ...
            Column(Modifier.padding(20.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        Text(
                            note.title.ifBlank { "BaÅŸlÄ±ksÄ±z Not" },
                            style = MaterialTheme.typography.titleLarge,
                            fontWeight = FontWeight.Bold,
                            color = MaterialTheme.colorScheme.onSurface
                        )
        ...
        Surface(
            ...
            Column(Modifier.padding(20.dp)) {
                ...
                if (noteBody.contains("[DrawingData:")) {
                    ...
                    Text(
                        cleanText.ifBlank { "Metin iÃ§eriÄŸi bulunmuyor, Ã§izim sekmesinden dÃ¼zenleyebilirsiniz." },
                        style = MaterialTheme.typography.bodyLarge,
                        color = MaterialTheme.colorScheme.onSurface,
                        lineHeight = 24.sp
                    )
                    ...
                    Surface(
                        ...
                        Row(
                            ...
                            Text(
                                "Bu not bir Ã§izim iÃ§eriyor. DÃ¼zenle butonuna basarak Ã§iziminizi gÃ¶rÃ¼ntÃ¼leyebilirsiniz.",
                                style = MaterialTheme.typography.bodySmall,
                                color = MaterialTheme.colorScheme.primary
                            )
                        }
        ...
        Surface(
            ...
            Row(
                ...
                FilledTonalButton(
                    ...
                    Icon(Icons.Default.Edit, contentDescription = "DÃ¼zenle", modifier = Modifier.size(20.dp))
                }
                ...
                FilledTonalButton(
                    ...
                    Icon(Icons.Default.Share, contentDescription = "PaylaÅŸ", modifier = Modifier.size(20.dp))
                }
        ...
        if (state.settings.debugMode) {
            ...
            Spacer(Modifier.height(8.dp))
            FilePreview(note.ocrImagePath, "OCR gÃ¶rÃ¼ntÃ¼sÃ¼")
            Spacer(Modifier.height(8.dp))
    ...
    ScreenColumn {
        ...
        Surface(
            ...
            Row(Modifier.padding(18.dp), verticalAlignment = Alignment.CenterVertically) {
                ...
                Column {
                    Text("ArÅŸiv", style = MaterialTheme.typography.headlineSmall, fontWeight = FontWeight.Bold)
                    Text(
                        "${state.archivedNotes.size} not arÅŸivde",
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
        ...
        if (state.archivedNotes.isEmpty()) {
            EmptyState("ArÅŸivde not yok.", "ArÅŸivlenen notlar burada gÃ¶rÃ¼nÃ¼r.")
        } else {
    ...
    Surface(
        ...
        Column(Modifier.padding(14.dp)) {
            Row(
                ...
                Column(modifier = Modifier.weight(1f)) {
                    Text(note.title.ifBlank { "BaÅŸlÄ±ksÄ±z not" }, style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.SemiBold)
                    ...
                    Text(note.preview.ifBlank { "BoÅŸ not" }, style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant, maxLines = 2, overflow = TextOverflow.Ellipsis)
                }
                Icon(Icons.Default.Description, contentDescription = null, tint = MaterialTheme.colorScheme.primary)
            }
            Spacer(Modifier.height(12.dp))
            Row(horizontalArrangement = Arrangement.spacedBy(10.dp), modifier = Modifier.fillMaxWidth()) {
                SecondaryActionButton("Geri YÃ¼kle", Icons.Default.Refresh, Modifier.weight(1f), onRestore)
...
private fun SamsungSettingsScreen(
    ...
    val categories = listOf("Genel & GÃ¶rÃ¼nÃ¼m", "Ã‡izim & Canvas", "AI & Backend", "Sistem & HakkÄ±nda")
    ...
    ScreenColumn {
        ...
        when (activeCategoryIndex) {
            0 -> {
                // Genel & GÃ¶rÃ¼nÃ¼m
                SamsungSettingsSection("GÃ¶rÃ¼nÃ¼m") {
                    SettingSwitchRow(
                        Icons.Default.Palette,
                        "Koyu Tema",
                        "Uygulama ve Canvas arka planÄ±nÄ± koyu yapar",
                        state.settings.useDarkTheme,
                        viewModel::setUseDarkTheme
                    )
                    SettingInfoRow(Icons.Default.Language, "Dil", "TÃ¼rkÃ§e")
                    SettingSwitchRow(
                        Icons.Default.Menu,
                        "Alt gezinme Ã§ubuÄŸu",
                        "Samsung Notes tarzÄ± iÃ§in varsayÄ±lan kapalÄ±",
            ...
            1 -> {
                ...
                SamsungSettingsSection("Canvas ve kalem") {
                    SettingSwitchRow(
                        Icons.Default.Brush,
                        "Parmakla Ã§izim",
                        "Stylus yokken canvas Ã§izimini aÃ§Ä±k tutar",
                    ...
                    SettingSwitchRow(
                        Icons.Default.Edit,
                        "Stylus basÄ±ncÄ±",
                        "Destekli kalemlerde deÄŸiÅŸken kalÄ±nlÄ±k iÃ§in hazÄ±r",
                    ...
                    SettingSwitchRow(
                        Icons.Default.Check,
                        "AvuÃ§ iÃ§i reddi",
                        "S Pen cihazlarda yanlÄ±ÅŸ temaslarÄ± azaltmak iÃ§in hazÄ±rlÄ±k",
                        state.settings.palmRejection,
                        viewModel::setPalmRejection
                    )
                    Spacer(Modifier.height(10.dp))
                    Text(
                        "Kalem kalÄ±nlÄ±ÄŸÄ±: ${"%.0f".format(state.settings.defaultPenWidth)}",
                        style = MaterialTheme.typography.labelLarge,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                    ...
                    Text(
                        "Maksimum yakÄ±nlaÅŸtÄ±rma: ${"%.1f".format(state.settings.canvasMaxZoom)}x",
                        style = MaterialTheme.typography.labelLarge,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
            ...
            2 -> {
                // AI & Backend
                SamsungSettingsSection("Not YapÄ±landÄ±rmasÄ±") {
                    SettingInfoRow(Icons.Default.Description, "VarsayÄ±lan kayÄ±t", "Otomatik kaydetme aÃ§Ä±k")
                    SettingSwitchRow(
                        Icons.Default.AutoAwesome,
                        "LLM ile dÃ¼zenleme",
                        "Not oluÅŸturma tercihleri",
                ...
                SamsungSettingsSection("Backend") {
                    SettingSwitchRow(
                        Icons.Default.AutoAwesome,
                        "FastAPI pipeline",
                        "Tahtadan ekle akÄ±ÅŸÄ±nda backend kullanÄ±lÄ±r",
                        state.settings.useBackendPipeline,
                        viewModel::setUseBackendPipeline
                    )
                    Spacer(Modifier.height(10.dp))
                    Row(horizontalArrangement = Arrangement.spacedBy(8.dp), modifier = Modifier.fillMaxWidth()) {
                        ModeButton("ADB tÃ¼neli", state.settings.backendBaseUrl == ADB_REVERSE_BACKEND_BASE_URL, Modifier.weight(1f)) {
            ...
            3 -> {
                // Sistem & GeliÅŸtirici
                SamsungSettingsSection("GeliÅŸtirici") {
                    SettingSwitchRow(Icons.Default.BugReport, "Debug modu", "Pipeline Ã§Ä±ktÄ±larÄ± ve tanÄ±lama", state.settings.debugMode, viewModel::setDebugMode)
                    Spacer(Modifier.height(10.dp))
                    OutlinedTextField(
                        value = state.settings.groqApiKey,
                        onValueChange = viewModel::setGroqApiKey,
                        label = { Text("Groq API anahtarÄ±") },
                        modifier = Modifier.fillMaxWidth(),
                        singleLine = true,
                        shape = RoundedCornerShape(14.dp)
                    )
                    ...
                    OcrEngineChoice.entries.forEach { choice ->
                        TextButton(onClick = { viewModel.setOcrEngineChoice(choice) }, modifier = Modifier.fillMaxWidth()) {
                            Text(if (state.settings.ocrEngineChoice == choice) "âœ“ ${choice.name}" else choice.name)
                        }
                    }
                }
                Spacer(Modifier.height(12.dp))
                SamsungSettingsSection("HakkÄ±nda & Bilgi") {
                    SettingActionRow(Icons.Default.Info, "Uygulama bilgisi", "SÃ¼rÃ¼m ve proje bilgileri", onAbout)
                    SettingInfoRow(Icons.Default.Description, "SÃ¼rÃ¼m", "0.9.0")
                }
            }
        }
...
private fun SettingsScreen(state: Board2NotesUiState, viewModel: Board2NotesViewModel, onAbout: () -> Unit) {
    ScreenColumn {
        ...
        SettingsSection(title = "Uygulama AyarlarÄ±") {
            SettingInfoRow(Icons.Default.AutoAwesome, "Tema", "Board2Note mavi/lacivert")
            SettingInfoRow(Icons.Default.Language, "Dil", "TÃ¼rkÃ§e")
            SettingInfoRow(Icons.Default.Notifications, "Bildirimler", "KapalÄ±")
        }

        Spacer(Modifier.height(16.dp))

        SettingsSection(title = "Not AyarlarÄ±") {
            SettingInfoRow(Icons.Default.Description, "VarsayÄ±lan kayÄ±t biÃ§imi", "DÃ¼zenlenebilir not")
            SettingInfoRow(Icons.Default.PictureAsPdf, "PDF dÄ±ÅŸa aktarma", "PaylaÅŸÄ±m seÃ§eneklerinden kullanÄ±labilir")
            SettingSwitchRow(Icons.Default.AutoAwesome, "LLM ile dÃ¼zenleme", "Not oluÅŸturma tercihleri", state.settings.llmEnabled, viewModel::setLlmEnabled)
            Spacer(Modifier.height(12.dp))
            Text(
                "Model 2 Ã¶nceliÄŸi",
                style = MaterialTheme.typography.titleSmall,
        ...
        SettingsSection(title = "Backend API") {
            SettingSwitchRow(
                Icons.Default.AutoAwesome,
                "FastAPI pipeline",
                "Not iÃ§inden yapÄ±lan taramalarda PyTorch backend kullanÄ±lÄ±r",
                state.settings.useBackendPipeline,
                viewModel::setUseBackendPipeline
            )
            Spacer(Modifier.height(12.dp))
            ...
            TextButton(onClick = { viewModel.setBackendBaseUrl(EMULATOR_BACKEND_BASE_URL) }) {
                Text(if (state.settings.backendBaseUrl == EMULATOR_BACKEND_BASE_URL) "âœ“ Emulator: $EMULATOR_BACKEND_BASE_URL" else "Emulator: $EMULATOR_BACKEND_BASE_URL")
            }
        }

        Spacer(Modifier.height(16.dp))

        SettingsSection(title = "GeliÅŸtirici ve OCR") {
            SettingSwitchRow(Icons.Default.BugReport, "Debug modu", "Pipeline Ã§Ä±ktÄ±larÄ± ve tanÄ±lama dosyalarÄ±", state.settings.debugMode, viewModel::setDebugMode)
            Spacer(Modifier.height(12.dp))
            OutlinedTextField(
                value = state.settings.groqApiKey,
                onValueChange = viewModel::setGroqApiKey,
        ...
        SettingsSection(title = "HakkÄ±nda") {
            SettingActionRow(Icons.Default.Info, "Uygulama bilgisi", "SÃ¼rÃ¼m ve proje bilgileri", onAbout)
            SettingInfoRow(Icons.Default.Description, "SÃ¼rÃ¼m bilgisi", "0.9.0 Ã¼rÃ¼n sÃ¼rÃ¼mÃ¼")
            SettingInfoRow(Icons.Default.Folder, "Proje bilgileri", "Board2Note yapay zekÃ¢ destekli not uygulamasÄ±")
        }

        Spacer(Modifier.height(16.dp))
        WarningText("TrOCR ve PaddleOCR adapterleri ileride baÄŸlanmak Ã¼zere ayrÄ±ldÄ±; bu sÃ¼rÃ¼mde birincil OCR ML Kit Latin kullanÄ±r.")
        Spacer(Modifier.height(18.dp))
    }
}
...
private fun SettingsHeroCard() {
    Surface(
        ...
        Row(Modifier.padding(18.dp), verticalAlignment = Alignment.CenterVertically) {
            ...
            Column {
                Text(
                    "Uygulama, not ve model tercihlerini yÃ¶netin.",
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
...
private fun AboutScreen() {
    ScreenColumn {
        ...
        Column(
            ...
            Spacer(Modifier.height(12.dp))
            Text(
                "Tahta gÃ¶rÃ¼ntÃ¼lerini yapay zeka desteÄŸiyle dÃ¼zenlenebilir ders notlarÄ±na dÃ¶nÃ¼ÅŸtÃ¼ren premium Android asistanÄ±nÄ±z.",
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
                lineHeight = 22.sp,
        ...
        Surface(
            ...
            Column(Modifier.padding(16.dp)) {
                AboutInfoLine("SÃ¼rÃ¼m", "0.9.3", Icons.Default.Info)
                AboutInfoLine("Gizlilik", "Notlar ve gÃ¶rseller cihazÄ±nÄ±zÄ±n yerel depolama alanÄ±nda gÃ¼venle saklanÄ±r.", Icons.Default.Description, showDivider = false)
            }
        }
        Spacer(Modifier.height(24.dp))
    }
...
private fun DebugArtifactsScreen(state: Board2NotesUiState, viewModel: Board2NotesViewModel) {
    ScreenColumn {
        Spacer(Modifier.height(16.dp))
        SectionTitle("Debug Ã§Ä±ktÄ±larÄ±", "Aktif pipeline gÃ¶rselleri ve metinleri geÃ§ici klasÃ¶re kaydedilir.")
        Spacer(Modifier.height(12.dp))
        Button(onClick = viewModel::exportDebugArtifacts, modifier = Modifier.fillMaxWidth()) {
            Icon(Icons.Default.BugReport, contentDescription = null)
            Spacer(Modifier.width(8.dp))
            Text("Debug Ã§Ä±ktÄ±larÄ±nÄ± kaydet")
        }
        Spacer(Modifier.height(12.dp))
...
private fun PipelineStepper(current: Int) {
    val steps = listOf("GÃ¶rÃ¼ntÃ¼", "Tahta", "Ä°yileÅŸtirme", "OCR", "Not")
...
private fun PipelineSummary() {
    Surface(modifier = Modifier.fillMaxWidth(), shape = RoundedCornerShape(8.dp), color = MaterialTheme.colorScheme.surfaceVariant) {
        Column(Modifier.padding(14.dp)) {
            Text("Ä°ÅŸlem akÄ±ÅŸÄ±", style = MaterialTheme.typography.titleMedium)
            Spacer(Modifier.height(8.dp))
            Text("1. Tahta alanÄ± bulunur ve crop dÃ¼zeltilir.")
            Text("2. YazÄ± netleÅŸtirilir ve beyaz sayfa Ã§Ä±ktÄ±sÄ± Ã¼retilir.")
            Text("3. OCR metni dÃ¼zenlenebilir nota dÃ¶nÃ¼ÅŸtÃ¼rÃ¼lÃ¼r.")
        }
    }
}
    ...
    Surface(
        ...
        Row(modifier = Modifier.padding(12.dp), verticalAlignment = Alignment.CenterVertically) {
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(note.preview.ifBlank { "BoÅŸ not" }, style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
        ...
        AlertDialog(
            ...
            title = {
                Text(
                    if (mode == FolderDeleteMode.Selected) {
                        "SeÃ§ili notlarÄ± silmek istiyor musunuz?"
                    } else {
                        "Bu dersteki tÃ¼m notlarÄ± silmek istiyor musunuz?"
                    },
                    fontWeight = FontWeight.Bold
                )
            },
            ...
            confirmButton = {
                Button(
                    ...
                    Text(if (mode == FolderDeleteMode.Selected) "Sil" else "TÃ¼mÃ¼nÃ¼ Sil")
                }
            },
            dismissButton = {
            ...
            Column(Modifier.padding(18.dp)) {
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Spacer(Modifier.height(4.dp))
                        Text(
                            if (selectionMode) "${selectedIds.size} not seÃ§ildi" else "${notes.size} not",
                            style = MaterialTheme.typography.bodyMedium,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
                ...
                if (selectionMode) {
                    Surface(
                        ...
                        Row(
                            ...
                            SecondaryActionButton("VazgeÃ§", null, Modifier.weight(1f)) {
                                selectionMode = false
                                selectedIds = emptySet()
                            }
                        }
...
private fun FolderEmptyState() {
    Surface(
        ...
        Column(
            ...
            Spacer(Modifier.height(14.dp))
            Text("Bu derste henÃ¼z not yok.", style = MaterialTheme.typography.titleMedium, fontWeight = FontWeight.Bold)
            Spacer(Modifier.height(6.dp))
            Text(
                "Yeni bir tahta notu oluÅŸturarak baÅŸlayÄ±n.",
                style = MaterialTheme.typography.bodyMedium,
                color = MaterialTheme.colorScheme.onSurfaceVariant,
                textAlign = TextAlign.Center
            )
...
private fun titleForRoute(route: String?): String = when {
    route == Route.Home -> ""
    route == Route.Capture -> ""
    route == Route.Review -> "GÃ¶rsel Ã–nizleme"
    route == Route.Crop -> "Tahta AlanÄ± SeÃ§imi"
    route == Route.Enhancement -> "GÃ¶rÃ¼ntÃ¼ Ä°yileÅŸtirme"
    route == Route.Ocr -> "OCR"
    route == Route.NoteEditor -> "Not EditÃ¶rÃ¼"
    route == Route.Notes -> ""
    route?.startsWith(Route.NoteDetail) == true -> "Not DetayÄ±"
    route?.startsWith(Route.Folder) == true -> "Ders NotlarÄ±"
    route == Route.Settings -> ""
    route == Route.About -> "HakkÄ±nda"
    route == Route.Archive -> "ArÅŸiv"
...
private fun shareNote(context: Context, note: FormattedNote) {
    ...
    context.startActivity(Intent.createChooser(intent, "Notu paylaÅŸ"))
}
...
private fun FavoritesScreen(
    ...
    ScreenColumn {
        ...
        if (state.favoriteNotes.isEmpty()) {
            EmptyState("Favori not yok.", "YÄ±ldÄ±z eklediÄŸiniz notlar burada gÃ¶rÃ¼nÃ¼r.")
        } else {
...
private fun FavoriteNoteCard(
    ...
    Surface(
        ...
        Column(Modifier.padding(14.dp)) {
            ...
            Spacer(Modifier.height(12.dp))
            Row(horizontalArrangement = Arrangement.spacedBy(10.dp), modifier = Modifier.fillMaxWidth()) {
                SecondaryActionButton("Favoriden Ã‡Ä±kar", Icons.Default.Star, Modifier.weight(1f), onToggleFavorite)
                DangerOutlineButton("Sil", Icons.Default.Delete, Modifier.weight(1f), onDelete)
            }
        }
    }
...
private fun TrashScreen(
    ...
    if (pendingPermanentDelete != null) {
        AlertDialog(
            ...
            shape = RoundedCornerShape(24.dp),
            title = { Text("KalÄ±cÄ± Olarak Sil") },
            text = { Text("Bu not kalÄ±cÄ± olarak silinecek ve geri alÄ±namayacak. Devam etmek istiyor musunuz?") },
            confirmButton = {
                Button(
                    onClick = {
            ...
            dismissButton = {
                TextButton(onClick = { pendingPermanentDelete = null }) { Text("VazgeÃ§") }
            }
        )
    }
    ...
    if (showEmptyTrashDialog) {
        AlertDialog(
            ...
            shape = RoundedCornerShape(24.dp),
            title = { Text("Ã‡Ã¶p Kutusunu BoÅŸalt") },
            text = { Text("Ã‡Ã¶p kutusundaki tÃ¼m notlar kalÄ±cÄ± olarak silinecek ve kurtarÄ±lamayacak. Devam etmek istiyor musunuz?") },
            confirmButton = {
                Button(
                    onClick = {
            ...
            dismissButton = {
                TextButton(onClick = { showEmptyTrashDialog = false }) { Text("VazgeÃ§") }
            }
        )
    }
    ...
    ScreenColumn {
        ...
        Surface(
            ...
            Row(
                ...
                Row(verticalAlignment = Alignment.CenterVertically) {
                    ...
                    Spacer(Modifier.width(14.dp))
                    Column {
                        Text("Ã‡Ã¶p Kutusu", style = MaterialTheme.typography.headlineSmall, fontWeight = FontWeight.Bold)
                        Text(
                            "${state.deletedNotes.size} not Ã§Ã¶p kutusunda",
                            style = MaterialTheme.typography.bodyMedium,
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                        )
                    }
        ...
        if (state.deletedNotes.isEmpty()) {
            EmptyState("Ã‡Ã¶p kutusu boÅŸ.", "Silinen notlar Ã§Ã¶p kutusunda saklanÄ±r.")
        } else {
...
private fun TrashNoteCard(
    ...
    Surface(
        ...
        Column(Modifier.padding(14.dp)) {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(10.dp), modifier = Modifier.fillMaxWidth()) {
                SecondaryActionButton("Geri YÃ¼kle", Icons.Default.Refresh, Modifier.weight(1f), onRestore)
                DangerOutlineButton("KalÄ±cÄ± Olarak Sil", Icons.Default.Delete, Modifier.weight(1f), onDeletePermanently)
            }
        }
    }
}
